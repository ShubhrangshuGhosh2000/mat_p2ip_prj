...
from proc.mat_p2ip.mat_p2ip_origMan_auxTlOtherMan_xai.mat_MatP2ipNetwork_origMan_auxTlOtherMan_rand50 import MatP2ipNetworkModule
from utils.ProjectDataLoader import *
from utils.feat_engg_manual_main import extract_prot_seq_2D_manual_feat
from proc.mat_p2ip.mat_p2ip_origMan_auxTlOtherMan_xai import mat_RunTrainTest_origMan_auxTlOtherMan_rand50
...
def execute():
    ...
    mat_RunTrainTest_origMan_auxTlOtherMan_rand50.runTest_xai(MatP2ipNetworkModule,testSets,folderName,hyp,predictionsFLst=pfs,startIdx=0,loads=saves)

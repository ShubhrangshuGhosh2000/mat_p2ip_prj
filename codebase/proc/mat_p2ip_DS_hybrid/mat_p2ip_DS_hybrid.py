...
def create_hybrid_score(spec_type = 'ecoli'):
    ...
    for index, row in combined_df.iterrows():
        ...
        # hybrid strategy:
        # Whenever mat_p2ip_DS is predicting positive and dscript is predicting negative for the same test sample, then the 
        ...
        if((mat_p2ip_DS_pred_prob_1 > 0.5) and (dscript_pred_prob_0 > 0.5)):
            ...
            print('mat_p2ip_DS_pred_prob_1: ' + str(mat_p2ip_DS_pred_prob_1) + ' : dscript_pred_prob_0: ' + str(dscript_pred_prob_0))
            ...
            # if mat_p2ip_DS predicts negative but original dscript predicts positive, then again apply

...
from proc.benchmark_algo.pipr_plus.pipr_plus_tl_auxOtherMan.piprp_ChenNetwork_tl_auxOtherMan_rand20 import ChenNetworkModule
...
from proc.benchmark_algo.pipr_plus.pipr_plus_tl_auxOtherMan import piprp_RunTrainTest_tl_auxOtherMan_rand20
...
def RunAll():    
    if chen2019RNN:
        ...
        if HumanRandom20:
            ...
            # piprp_RunTrainTest_tl_auxOtherMan_rand20.runTestLst(ChenNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True, modelsLst=None,saveModels=convertToFolder(saves),predictionsFLst = pfs,startIdx=0)
            piprp_RunTrainTest_tl_auxOtherMan_rand20.runTestLst(ChenNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True, modelsLst=None,saveModels=None,predictionsFLst = pfs,startIdx=0)
            piprp_RunTrainTest_tl_auxOtherMan_rand20.calcOverallScore_Pos20(outResultsNameLst)

...
from proc.benchmark_algo.pipr_plus.pipr_plus_origManTl_auxOtherMan.piprp_ChenNetwork_origManTl_auxOtherMan_rand50 import ChenNetworkModule
...
from proc.benchmark_algo.pipr_plus.pipr_plus_origManTl_auxOtherMan import piprp_RunTrainTest_origManTl_auxOtherMan_rand50
...
def RunAll():    
    if chen2019RNN:
        ...
        #     runTests(ChenNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True, modelsLst=None,saveModels=convertToFolder(saves),predictionsFLst = pfs)

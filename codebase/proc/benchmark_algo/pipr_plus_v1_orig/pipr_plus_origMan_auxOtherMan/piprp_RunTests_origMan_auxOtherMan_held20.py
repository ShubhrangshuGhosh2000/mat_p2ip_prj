...
from proc.benchmark_algo.pipr_plus.pipr_plus_origMan_auxOtherMan.piprp_ChenNetwork_origMan_auxOtherMan_held20 import ChenNetworkModule
...
from proc.benchmark_algo.pipr_plus.pipr_plus_origMan_auxOtherMan import piprp_RunTrainTest_origMan_auxOtherMan_held20
...
def RunAll():    
    if chen2019RNN:
        ...
        #     # pipr_RunTrainTest_origMan_auxOtherMan_held50.runTest(ChenNetworkModule, outResultsName,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=convertToFolder(saves),predictionsFLst = pfs,startIdx=0)
        #     piprp_RunTrainTest_origMan_auxOtherMan_held50.runTest(ChenNetworkModule, outResultsName,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=None,predictionsFLst = pfs,startIdx=0)
        #     piprp_RunTrainTest_origMan_auxOtherMan_held50.calcOverallScore_Pos50(outResultsName)
        ...
        if HumanHeldOut20:
            ...
            # piprp_RunTrainTest_origMan_auxOtherMan_held20.runTestLst(ChenNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=convertToFolder(saves),predictionsFLst = pfs,startIdx=0)
            piprp_RunTrainTest_origMan_auxOtherMan_held20.runTestLst(ChenNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=None,predictionsFLst = pfs,startIdx=0)
            piprp_RunTrainTest_origMan_auxOtherMan_held20.calcOverallScore_Pos20(outResultsNameLst)

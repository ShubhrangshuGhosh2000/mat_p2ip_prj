...
from proc.benchmark_algo.pipr_plus.pipr_plus_auxTl.piprp_ChenNetwork_auxTl_rand20 import ChenNetworkModule
...
from proc.benchmark_algo.pipr_plus.pipr_plus_auxTl import piprp_RunTrainTest_auxTl_rand20
...
def RunAll():    
    if chen2019RNN:
        ...
        if HumanRandom20:
            ...
            # piprp_RunTrainTest_auxTl_rand20.runTestLst(ChenNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True, modelsLst=None,saveModels=convertToFolder(saves),predictionsFLst = pfs,startIdx=0)
            piprp_RunTrainTest_auxTl_rand20.runTestLst(ChenNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True, modelsLst=None,saveModels=None,predictionsFLst = pfs,startIdx=0)
            piprp_RunTrainTest_auxTl_rand20.calcOverallScore_Pos20(outResultsNameLst)

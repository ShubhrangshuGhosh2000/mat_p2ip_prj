...
from proc.benchmark_algo.pipr_plus.pipr_plus_origMan.piprp_ChenNetwork_origMan_held50 import ChenNetworkModule
from utils.ProjectDataLoader import *
from utils.feat_engg_manual_main import extract_prot_seq_2D_manual_feat
from proc.benchmark_algo.pipr_plus.pipr_plus_origMan import piprp_RunTrainTest_origMan_held50
...
def RunAll():    
    if chen2019RNN:
        ...
        if HumanHeldOut50:
            ...
            # pipr_RunTrainTest_origManolderName,hyp,resultsAppend=True,saveModels=convertToFolder(saves),predictionsFLst = pfs,startIdx=0)

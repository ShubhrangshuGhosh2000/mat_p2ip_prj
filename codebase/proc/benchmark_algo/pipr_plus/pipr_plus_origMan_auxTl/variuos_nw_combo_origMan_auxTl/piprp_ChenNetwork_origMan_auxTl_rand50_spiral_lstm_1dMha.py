...
class ChenNetwork(nn.Module):
    def __init__(self,hiddenSize=50,inSize=14,aux_oneDencodingsize=1024,numLayers=6,seed=1,fullGPU=False,deviceType='cpu'):
        ...
        d_model = 16  # This can be any value divisible by n_heads. 512 is used in the original transformer paper. Default 512
    ...
    def forward(self,x):
        ...
        # print("From model.forward(): Size of x after Multihead Attention layer: {}".format(x.size()))

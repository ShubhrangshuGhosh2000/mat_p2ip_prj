...
from proc.benchmark_algo.pipr_plus.pipr_plus_origMan_auxTlOtherMan_xai.piprp_ChenNetwork_origMan_auxTlOtherMan_held50 import ChenNetworkModule
...
from proc.benchmark_algo.pipr_plus.pipr_plus_origMan_auxTlOtherMan_xai import piprp_RunTrainTest_origMan_auxTlOtherMan_held50
...
def RunAll():    
    if chen2019RNN:
        ...
        if HumanHeldOut50:
            ...
            # piprp_RunTrainTest_origMan_auxTlOtherMan_held50.runTest(ChenNetworkModule, outResultsName,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=saves,predictionsFLst = pfs,startIdx=0)
            # piprp_RunTrainTest_origMan_auxTlOtherMan_held50.calcOverallScore_Pos50(outResultsName)
            piprp_RunTrainTest_origMan_auxTlOtherMan_held50.runTest_xai(ChenNetworkModule,testSets,folderName,hyp,predictionsFLst=pfs,startIdx=0,loads=saves)

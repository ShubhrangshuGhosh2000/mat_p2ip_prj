...
from proc.benchmark_algo.pipr_plus.pipr_plus_origMan_auxTlOtherMan_xai.piprp_ChenNetwork_origMan_auxTlOtherMan_rand20 import ChenNetworkModule
from utils.ProjectDataLoader import *
from utils.feat_engg_manual_main import extract_prot_seq_2D_manual_feat
from proc.benchmark_algo.pipr_plus.pipr_plus_origMan_auxTlOtherMan_xai import piprp_RunTrainTest_origMan_auxTlOtherMan_rand20
...
def RunAll():    
    if chen2019RNN:
        ...
        if HumanRandom20:
            ...
            # piprp_RunTrainTest_origMan_auxTlOtherMan_rand20.runTestLst(ChenNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True, modelsLst=None,saveModels=saves,predictionsFLst = pfs,startIdx=0)
            # piprp_RunTrainTest_origMan_auxTlOtherMan_rand20.calcOverallScore_Pos20(outResultsNameLst)
            piprp_RunTrainTest_origMan_auxTlOtherMan_rand20.runTestLst_xai(ChenNetworkModule,testSets,folderName,hyp,predictionsFLst=pfs,startIdx=2,loads=saves)

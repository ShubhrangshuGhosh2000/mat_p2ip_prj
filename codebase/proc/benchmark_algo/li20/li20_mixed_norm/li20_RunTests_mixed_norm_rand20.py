...
from proc.benchmark_algo.li20.li20_mixed_norm.LiDeepNetwork_mixed_norm_rand20 import LiDeepNetworkModule
import time
...
from proc.benchmark_algo.li20.li20_mixed_norm import RunTrainTest_mixed_norm_Rand20
...
def RunAll():    
    if li2020Test:
        ...
        if HumanRandom20:
            ...
            # RunTrainTest_mixed_norm_Rand20.runTestLst(LiDeepNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True, modelsLst=None,saveModels=convertToFolder(saves),predictionsFLst = pfs,startIdx=0)
            RunTrainTest_mixed_norm_Rand20.runTestLst(LiDeepNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True, modelsLst=None,saveModels=None,predictionsFLst = pfs,startIdx=0)
            RunTrainTest_mixed_norm_Rand20.calcOverallScore_Pos20(outResultsNameLst)

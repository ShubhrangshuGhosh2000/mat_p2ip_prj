...
from proc.benchmark_algo.li20.li20_mixed_norm.LiDeepNetwork_mixed_norm_rand50 import LiDeepNetworkModule
import time
...
from proc.benchmark_algo.li20.li20_mixed_norm import RunTrainTest_mixed_norm_Rand50
...
def RunAll():    
    if li2020Test:
        ...
        if HumanRandom50:
            ...
            # RunTrainTest_mixed_norm_Rand50.runTest(LiDeepNetworkModule, outResultsName,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=convertToFolder(saves),predictionsFLst = pfs,startIdx=0)
            RunTrainTest_mixed_norm_Rand50.runTest(LiDeepNetworkModule, outResultsName,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=None,predictionsFLst = pfs,startIdx=0)
            RunTrainTest_mixed_norm_Rand50.calcOverallScore_Pos50(outResultsName)

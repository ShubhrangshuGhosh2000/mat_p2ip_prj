...
class LiDeepModel(object):
    ...
    def fit(self,features,classes):
        ...
        temp_pkl_file_names_lst = glob.glob(os.path.join('temp_result', 'temp_man_orig_held20_*.pkl'))
        ...
        for netType in netTypeLst:  #['AAC','LD','CT','PAAC']
            ...
            temp_pkl_file_nm_with_location = os.path.join('temp_result', 'temp_man_orig_held20_' + str(modelIdx) + '_' + str(netType) + '.pkl')

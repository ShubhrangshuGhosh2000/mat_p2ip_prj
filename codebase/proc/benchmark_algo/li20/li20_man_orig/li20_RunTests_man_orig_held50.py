...
from proc.benchmark_algo.li20.li20_man_orig.LiDeepNetwork_man_orig_held50 import LiDeepNetworkModule
import time
...
from proc.benchmark_algo.li20.li20_man_orig import RunTrainTest_man_orig_Held50
...
def RunAll():    
    if li2020Test:
        ...
        if HumanHeldOut50:
            ...
            # RunTrainTest_man_orig_Held50.runTest(LiDeepNetworkModule, outResultsName,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=convertToFolder(saves),predictionsFLst = pfs,startIdx=0)
            RunTrainTest_man_orig_Held50.runTest(LiDeepNetworkModule, outResultsName,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=None,predictionsFLst = pfs,startIdx=0)
            RunTrainTest_man_orig_Held50.calcOverallScore_Pos50(outResultsName)

...
from proc.benchmark_algo.li20.li20_man_orig.LiDeepNetwork_man_orig_held20 import LiDeepNetworkModule
import time
...
from proc.benchmark_algo.li20.li20_man_orig import RunTrainTest_man_orig_Held20
...
def RunAll():    
    if li2020Test:
        ...
        if HumanHeldOut20:
            ...
            # RunTrainTest_man_orig_Held20.runTestLst(LiDeepNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=convertToFolder(saves),predictionsFLst = pfs,startIdx=0)
            RunTrainTest_man_orig_Held20.runTestLst(LiDeepNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=None,predictionsFLst = pfs,startIdx=0)
            RunTrainTest_man_orig_Held20.calcOverallScore_Pos20(outResultsNameLst)

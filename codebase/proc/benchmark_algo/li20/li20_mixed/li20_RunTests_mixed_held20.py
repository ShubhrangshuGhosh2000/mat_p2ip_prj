...
from proc.benchmark_algo.li20.li20_mixed.LiDeepNetwork_mixed_held20 import LiDeepNetworkModule
import time
...
from proc.benchmark_algo.li20.li20_mixed import RunTrainTest_mixed_Held20
...
def RunAll():    
    if li2020Test:
        ...
        if HumanHeldOut20:
            ...
            # RunTrainTest_mixed_Held20.runTestLst(LiDeepNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=convertToFolder(saves),predictionsFLst = pfs,startIdx=0)
            # RunTrainTest_mixed_Held20.runTestLst(LiDeepNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=None,predictionsFLst = pfs,startIdx=12)
            RunTrainTest_mixed_Held20.calcOverallScore_Pos20(outResultsNameLst)

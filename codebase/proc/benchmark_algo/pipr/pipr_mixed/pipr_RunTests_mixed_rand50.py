...
from proc.benchmark_algo.pipr.pipr_mixed.ChenNetwork_mixed_rand50 import ChenNetworkModule
...
from proc.benchmark_algo.pipr.pipr_mixed import pipr_RunTrainTest_mixed_rand50
...
def RunAll():    
    if chen2019RNN:
        ...
        if HumanRandom50:
            ...
            pipr_RunTrainTest_mixed_rand50.runTest(ChenNetworkModule, outResultsName,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=None,predictionsFLst = pfs,startIdx=0)
        ...
        #     runTesmixedst(ChenNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True, modelsLst=None,saveModels=convertToFolder(saves),predictionsFLst = pfs)
        ...
        #     runTesmixedst(ChenNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=convertToFolder(saves),predictionsFLst = pfs)
        #     calcOverallScore_Pos20(outResultsNameLst)

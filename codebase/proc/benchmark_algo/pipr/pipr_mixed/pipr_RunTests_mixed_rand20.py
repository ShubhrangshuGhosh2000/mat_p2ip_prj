...
from proc.benchmark_algo.pipr.pipr_mixed.ChenNetwork_mixed_rand20 import ChenNetworkModule
...
from proc.benchmark_algo.pipr.pipr_mixed import pipr_RunTrainTest_mixed_rand20
...
def RunAll():    
    if chen2019RNN:
        ...
        if HumanRandom20:
            ...
            # pipr_RunTrainTest_mixed_rand20.runTestLst(ChenNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True, modelsLst=None,saveModels=convertToFolder(saves),predictionsFLst = pfs,startIdx=0)
            pipr_RunTrainTest_mixed_rand20.runTestLst(ChenNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True, modelsLst=None,saveModels=None,predictionsFLst = pfs,startIdx=0)
            pipr_RunTrainTest_mixed_rand20.calcOverallScore_Pos20(outResultsNameLst)

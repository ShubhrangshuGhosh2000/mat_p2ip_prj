...
from utils_benchmark.GenericNetworkModel import GenericNetworkModel
from utils_benchmark.GenericNetworkModule import GenericNetworkModule
import torch
...
class ChenNetworkModule(GenericNetworkModule):
    ...
    def loadFeatureData(self,featureFolder):
        ...
        self.encodingSize = self.inSize = dataMatrixSkip.shape[1] + dataMatrixOneHot.shape[1] + human_seq_feat_2d_reg_dict[int(allProteinsList[0])].shape[1]
        ...
        for item in allProteinsList:
            ...
            self.dataMatrix[self.dataLookup[item],:,(skipData.shape[1] + oneHotData.shape[1]):] = torch.from_numpy(human_seq_feat_2d_reg_dict[int(item)])

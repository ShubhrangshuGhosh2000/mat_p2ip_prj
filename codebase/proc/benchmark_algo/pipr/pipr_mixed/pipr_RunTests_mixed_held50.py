...
from proc.benchmark_algo.pipr.pipr_mixed.ChenNetwork_mixed_held50 import ChenNetworkModule
...
from proc.benchmark_algo.pipr.pipr_mixed import pipr_RunTrainTest_mixed_held50
...
def RunAll():    
    if chen2019RNN:
        ...
        if HumanHeldOut50:
            ...
            pipr_RunTrainTest_mixed_held50.runTest(ChenNetworkModule, outResultsName,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=None,predictionsFLst = pfs,startIdx=0)

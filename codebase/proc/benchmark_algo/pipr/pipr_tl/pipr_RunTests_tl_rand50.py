...
from proc.benchmark_algo.pipr.pipr_tl.ChenNetwork_tl_rand50 import ChenNetworkModule
...
from proc.benchmark_algo.pipr.pipr_tl import pipr_RunTrainTest_tl_rand50
...
def RunAll():    
    if chen2019RNN:
        ...
        if HumanRandom50:
            ...
            pipr_RunTrainTest_tl_rand50.runTest(ChenNetworkModule, outResultsName,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=None,predictionsFLst = pfs,startIdx=0)

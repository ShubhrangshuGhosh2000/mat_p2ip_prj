...
from proc.benchmark_algo.pipr_plus.pipr_plus_origMan_auxTlOtherMan.piprp_ChenNetwork_origMan_auxTlOtherMan_rand20 import ChenNetworkModule
...
from proc.benchmark_algo.pipr_plus.pipr_plus_origMan_auxTlOtherMan import piprp_RunTrainTest_origMan_auxTlOtherMan_rand20
...
baseResultsFolderName = os.path.join(root_path, 'dataset/proc_data/benchmark_res/piprp_res/piprp_res_origMan_auxTlOtherMan/')
...
def RunAll():    
    if chen2019RNN:
        ...
        if HumanRandom20:
            ...
            # piprp_RunTrainTest_origMan_auxTlOtherMan_rand20.runTestLst(ChenNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True, modelsLst=None,saveModels=convertToFolder(saves),predictionsFLst = pfs,startIdx=0)
            piprp_RunTrainTest_origMan_auxTlOtherMan_rand20.runTestLst(ChenNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True, modelsLst=None,saveModels=None,predictionsFLst = pfs,startIdx=0)
            piprp_RunTrainTest_origMan_auxTlOtherMan_rand20.calcOverallScore_Pos20(outResultsNameLst)

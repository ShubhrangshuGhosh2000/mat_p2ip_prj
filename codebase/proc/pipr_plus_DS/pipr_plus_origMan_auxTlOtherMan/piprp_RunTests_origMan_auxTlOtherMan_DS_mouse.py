...
from proc.pipr_plus_DS.pipr_plus_origMan_auxTlOtherMan.piprp_ChenNetwork_origMan_auxTlOtherMan_DS_test import ChenNetworkModule
...
if __name__ == '__main__':
    spec_type = 'mouse'  # human, ecoli, fly, mouse, worm, yeast

...
from proc.mtf_p2ip.mtf_p2ip_origMan_auxTlOtherMan_xai.mtf_ChenNetwork_origMan_auxTlOtherMan_rand50 import ChenNetworkModule
...
def RunAll():    
    if chen2019RNN:
        ...
        if HumanRandom50:
            ...
            mtf_RunTrainTest_origMan_auxTlOtherMan_rand50.runTest_xai(ChenNetworkModule,testSets,folderName,hyp,predictionsFLst=pfs,startIdx=0,loads=saves)

...
from proc.mtf_p2ip.mtf_p2ip_origMan_auxTlOtherMan_xai.mtf_MtfP2ipNetwork_origMan_auxTlOtherMan_rand50 import MtfP2ipNetworkModule
from utils.ProjectDataLoader import *
from utils.feat_engg_manual_main import extract_prot_seq_2D_manual_feat
from proc.mtf_p2ip.mtf_p2ip_origMan_auxTlOtherMan_xai import mtf_RunTrainTest_origMan_auxTlOtherMan_rand50
...
def RunAll():    
    if mtfP2ip2019RNN:
        ...
        if HumanRandom50:
            ...
            mtf_RunTrainTest_origMan_auxTlOtherMan_rand50.runTest_xai(MtfP2ipNetworkModule,testSets,folderName,hyp,predictionsFLst=pfs,startIdx=0,loads=saves)

...
from proc.mtf_p2ip.mtf_p2ip_origMan_auxTlOtherMan_xai.mtf_ChenNetwork_origMan_auxTlOtherMan_held20 import ChenNetworkModule
...
baseResultsFolderName = os.path.join(root_path, 'dataset/proc_data/benchmark_res/mtf_res/mtf_res_origMan_auxTlOtherMan_xai/')
...
def RunAll():    
    if chen2019RNN:
        ...
        if HumanHeldOut20:
            ...
            # mtf_RunTrainTest_origMan_auxTlOtherMan_held20.runTestLst(ChenNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=saves,predictionsFLst = pfs,startIdx=0)
            # mtf_RunTrainTest_origMan_auxTlOtherMan_held20.calcOverallScore_Pos20(outResultsNameLst)
            mtf_RunTrainTest_origMan_auxTlOtherMan_held20.runTestLst_xai(ChenNetworkModule,testSets,folderName,hyp,predictionsFLst=pfs,startIdx=0,loads=saves)

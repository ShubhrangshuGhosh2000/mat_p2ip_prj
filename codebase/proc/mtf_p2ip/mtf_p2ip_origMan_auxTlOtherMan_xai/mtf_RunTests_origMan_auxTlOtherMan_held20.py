...
def RunAll():    
    if mtfP2ip2019RNN:
        ...
        if HumanHeldOut20:
            ...
            # mtf_RunTrainTest_origMan_auxTlOtherMan_held20.runTestLst(MtfP2ipNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=saves,predictionsFLst = pfs,startIdx=0)

...
from proc.mtf_p2ip.pipr_plus_origMan_auxTlOtherMan_xai.piprp_ChenNetwork_origMan_auxTlOtherMan_held20 import ChenNetworkModule
from utils.ProjectDataLoader import *
from utils.feat_engg_manual_main import extract_prot_seq_2D_manual_feat
from proc.mtf_p2ip.pipr_plus_origMan_auxTlOtherMan_xai import piprp_RunTrainTest_origMan_auxTlOtherMan_held20
...
def RunAll():    
    if chen2019RNN:
        ...
        if HumanHeldOut20:
            ...
            # piprp_RunTrainTest_origMan_auxTlOtherMan_held20.runTestLst(ChenNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=saves,predictionsFLst = pfs,startIdx=0)
            # piprp_RunTrainTest_origMan_auxTlOtherMan_held20.calcOverallScore_Pos20(outResultsNameLst)
            piprp_RunTrainTest_origMan_auxTlOtherMan_held20.runTestLst_xai(ChenNetworkModule,testSets,folderName,hyp,predictionsFLst=pfs,startIdx=0,loads=saves)

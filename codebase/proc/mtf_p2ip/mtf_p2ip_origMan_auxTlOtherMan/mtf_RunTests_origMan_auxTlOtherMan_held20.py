...
from proc.mtf_p2ip.mtf_p2ip_origMan_auxTlOtherMan.mtf_ChenNetwork_origMan_auxTlOtherMan_held20 import ChenNetworkModule
...
def RunAll():    
    if chen2019RNN:
        ...
        #     mtf_RunTrainTest_origMan_auxTlOtherMan_held50.runTest(ChenNetworkModule, outResultsName,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=None,predictionsFLst = pfs,startIdx=0)
        ...
        if HumanHeldOut20:
            ...
            # mtf_RunTrainTest_origMan_auxTlOtherMan_held20.runTestLst(ChenNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=convertToFolder(saves),predictionsFLst = pfs,startIdx=0)
            mtf_RunTrainTest_origMan_auxTlOtherMan_held20.runTestLst(ChenNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True,saveModels=None,predictionsFLst = pfs,startIdx=0)

...
from proc.mtf_p2ip.mtf_p2ip_origMan_auxTlOtherMan.mtf_MtfP2ipNetwork_origMan_auxTlOtherMan_rand50 import MtfP2ipNetworkModule
from utils.ProjectDataLoader import *
from utils.feat_engg_manual_main import extract_prot_seq_2D_manual_feat
from proc.mtf_p2ip.mtf_p2ip_origMan_auxTlOtherMan import mtf_RunTrainTest_origMan_auxTlOtherMan_rand50
...
baseResultsFolderName = os.path.join(root_path, 'dataset/proc_data/benchmark_res/mtf_res/mtf_res_origMan_auxTlOtherMan/')

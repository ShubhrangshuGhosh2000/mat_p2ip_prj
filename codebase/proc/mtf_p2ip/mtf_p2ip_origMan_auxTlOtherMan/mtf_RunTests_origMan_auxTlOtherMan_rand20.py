...
def RunAll():    
    if chen2019RNN:
        ...
        if HumanRandom20:
            ...
            mtf_RunTrainTest_origMan_auxTlOtherMan_rand20.runTestLst(MtfP2ipNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True, modelsLst=None,saveModels=None,predictionsFLst = pfs,startIdx=0)

...
from proc.mtf_p2ip.mtf_p2ip_origMan_auxTlOtherMan.mtf_ChenNetwork_origMan_auxTlOtherMan_rand20 import ChenNetworkModule
...
def RunAll():    
    if chen2019RNN:
        ...
        if HumanRandom20:
            ...
            # mtf_RunTrainTest_origMan_auxTlOtherMan_rand20.runTestLst(ChenNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True, modelsLst=None,saveModels=convertToFolder(saves),predictionsFLst = pfs,startIdx=0)
            mtf_RunTrainTest_origMan_auxTlOtherMan_rand20.runTestLst(ChenNetworkModule, outResultsNameLst,trainSets,testSets,folderName,hyp,resultsAppend=True, modelsLst=None,saveModels=None,predictionsFLst = pfs,startIdx=0)

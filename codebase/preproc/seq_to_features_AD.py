...
def add_protTrans_feat_to_AD_seq(root_path='./', protTrans_model_path='./', protTrans_model_name = 'prot_t5_xl_uniref50'):
    ...
    print('\n ########## extract features using the protTrans model (tl model) for the AD_sequence list ########## ')
    features_lst, features_2d_lst = preproc_util.extract_feat_from_protTrans(AD_seq_df['seq'].tolist(), protTrans_model_path, protTrans_model_name)
...
if __name__ == '__main__':
    ...
    add_protTrans_feat_to_AD_seq(root_path
